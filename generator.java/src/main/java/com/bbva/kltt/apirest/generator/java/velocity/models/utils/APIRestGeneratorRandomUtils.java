 ...
 * ------------------------------------------------
 */
public class APIRestGeneratorRandomUtils extends GeneratorBaseJavaModels
{
    /**
     * Build the random utils generator
     *
     * @param baseDestDir       with the base destination directory for the generated file
     * @param generationParams  with the parameters for the generation for java
     * @param parsedInfoHandler with the parsed information handler
     */
    public APIRestGeneratorRandomUtils(final File baseDestDir, final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
    ...
    {
        return ConstantsOutputJava.CLASSNAME_RANDOM_UTILS + this.getTitleCamelCase();
    }
}
