...
public interface IOperationsModelJava extends IOperationsModel
{
	 ...
	 */
	void generateBaseInterfaceModels(final File destDir) throws APIRestGeneratorException ;
	 ...
	 * @throws APIRestGeneratorException with an occurred exception
	 */
	void generateModelUtilities(final File destDir) throws APIRestGeneratorException ;
	 ...
	 * @throws APIRestGeneratorException with an occurred exception
	 */
	void generateModelTests(final File destDir) throws APIRestGeneratorException ;
