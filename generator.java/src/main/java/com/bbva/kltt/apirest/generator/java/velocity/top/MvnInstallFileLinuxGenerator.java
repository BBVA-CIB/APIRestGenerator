 ...
 * ------------------------------------------------
 */
public class MvnInstallFileLinuxGenerator extends GeneratorBase
{
    /**
     * Translator type
     */
     ...
     */
    public MvnInstallFileLinuxGenerator(final File baseDestDir,
    ...
    {
        return ConstantsCommon.STRING_DOT + ConstantsOutput.EXTENSION_SH;
    }
}
