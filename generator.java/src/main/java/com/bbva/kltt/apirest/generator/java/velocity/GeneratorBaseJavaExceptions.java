...
import com.bbva.kltt.apirest.generator.java.output.language.OutputLanguageItemsExceptionsJava;

/**
 * Generator to create the class that represents a exception model from the specification in java
 * ------------------------------------------------
 * @author Francisco Manuel Benitez Chico
 * ------------------------------------------------
 */
public abstract class GeneratorBaseJavaExceptions extends GeneratorBaseJava
{
    /**
     ...
     */
    public GeneratorBaseJavaExceptions(final File baseDestDir, final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
        super(baseDestDir, generationParams, parsedInfoHandler) ;

        this.outputLanguageItems = new OutputLanguageItemsExceptionsJava(parsedInfoHandler) ;
    }
