...
public abstract class TranslatorGeneratorBaseJava extends TranslatorGeneratorBase
{
	...
	public String getGeneratorInfoProjectsChildren()
	{
		...
		final String generatorJavaInfo = FilesUtility.loadFileContentFromClasspath(ConstantsOutputJava.PROJECT_NAME +
		...
		final String childreProjectsInfoJava = this.getGeneratorInfoProjectsChildrenJava() ;
	...
	/**
	 * @return the generator info projects children for java projects
	 */
	public abstract String getGeneratorInfoProjectsChildrenJava() ;
}
