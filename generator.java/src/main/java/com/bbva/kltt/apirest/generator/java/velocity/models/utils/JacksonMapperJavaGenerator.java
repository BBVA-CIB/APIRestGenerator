...
public class JacksonMapperJavaGenerator extends GeneratorBaseJavaModels
{
     ...
     */
    public JacksonMapperJavaGenerator(final File baseDestDir, final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
    ...
    {
        return ConstantsOutputJava.CLASSNAME_JACKSON_MAPPER;
    }
}
