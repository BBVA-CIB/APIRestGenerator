...
public class ModelsPOMJavaGenerator extends GeneratorBasePOM
{
     ...
     */
    public ModelsPOMJavaGenerator(final File baseDestDir, final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler, final String pomFileName)
    {
        super(baseDestDir, ConstantsCommon.STRING_EMPTY, generationParams, parsedInfoHandler, pomFileName) ;
    }
