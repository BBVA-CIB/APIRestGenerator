...
import com.bbva.kltt.apirest.generator.java.interfaces.IOperationsRestImplJava;
 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorJavaRestImplBase extends TranslatorGeneratorBaseJava implements IOperationsRestImplJava
{
    /**
     ...
     */
    public TranslatorGeneratorJavaRestImplBase(final String translatorType,
    ...
    public void generateSpecific() throws APIRestGeneratorException
    {
        ...
        // Generate the rest handler test classes
        this.generateRestHandlerTests(this.getTestDir());
    ...
    {
        return ConstantsOutput.OUTPUT_CODE_TYPE_REST + ConstantsCommon.STRING_HYPHEN + ConstantsOutput.OUTPUT_CODE_SUBTYPE_IMPL;
    }
}
