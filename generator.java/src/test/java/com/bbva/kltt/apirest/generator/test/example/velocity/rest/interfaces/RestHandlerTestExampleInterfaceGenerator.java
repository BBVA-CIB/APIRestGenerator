 ...
 * ------------------------------------------------
 */
public class RestHandlerTestExampleInterfaceGenerator extends GeneratorBaseTestExample
{
    /**
     ...
     */
    public RestHandlerTestExampleInterfaceGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        // Spring Templates
        context.put(ConstantsOutputTestExample.VP_SPR_TEMPL_REST_MET_HEA_IN,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputTestExample.VP_SPR_TEMPL_REST_MET_HEA_IN)) ;
