 ...
 * ------------------------------------------------
 */
public class RestListenerTestExampleInterfaceGenerator extends GeneratorBaseTestExample
{
    /**
     ...
     */
    public RestListenerTestExampleInterfaceGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        // Spring Templates
        context.put(ConstantsOutputTestExample.VP_SPR_TEMPL_LIST_MET_H_IN,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputTestExample.VP_SPR_TEMPL_LIST_MET_H_IN)) ;
