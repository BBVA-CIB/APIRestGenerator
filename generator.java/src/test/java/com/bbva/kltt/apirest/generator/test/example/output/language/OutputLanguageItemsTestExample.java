 ...
 * ------------------------------------------------
 */
public class OutputLanguageItemsTestExample extends OutputLanguageItemsJava
{
	/**
	 * Public constructor
	 * @param parsedInfoHandler with the parsed information handler
	 */
	public OutputLanguageItemsTestExample(final ParsedInfoHandler parsedInfoHandler)
	{
	...
	{
		return ConstantsOutputTestExample.OUTPUT_TYPE_FILE ;
	}
}
