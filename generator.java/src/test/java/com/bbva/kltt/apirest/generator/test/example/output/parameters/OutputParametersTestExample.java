...
package com.bbva.kltt.apirest.generator.test.example.output.parameters;

import com.bbva.kltt.apirest.generator.java.output.parameters.OutputParametersJava;
 ...
 * ------------------------------------------------
 */
public class OutputParametersTestExample extends OutputParametersJava
{
	/**
	 * Public constructor
	 ...
	 */
	public OutputParametersTestExample(final IOutputLanguageSeparators outputLangSeparators, final List<OutputParameter> outputParamsList)
	{
	...
	@Override
	protected void getParametersHeaderRestSpecific(final StringBuilder currentOutcome, final OutputParameter outputParameter)
	{
		// There is nothing awesome to do
	}
	
	@Override
	protected void getParametersTestSpecific(final StringBuilder currentOutcome, final OutputParameter outputParameter)
	{
		// There is nothing awesome to do
	}
}
