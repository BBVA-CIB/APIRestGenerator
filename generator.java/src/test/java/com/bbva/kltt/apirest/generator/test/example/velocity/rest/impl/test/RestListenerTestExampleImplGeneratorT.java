 ...
 * ------------------------------------------------
 */
public class RestListenerTestExampleImplGeneratorT extends GeneratorBaseTestExample
{
    /**
     ...
     */
    public RestListenerTestExampleImplGeneratorT(final File baseDestDir,
    ...
    private List<String> generateAdditionalImports()
    {
        ...
        additionalImports.add(ConstantsOutputTestExample.SPRING_MULTIPART_CLASS_PKG);
        additionalImports.add(ConstantsOutputTestExample.JAVA_IO_IO_EXCEPTION_PKG);
