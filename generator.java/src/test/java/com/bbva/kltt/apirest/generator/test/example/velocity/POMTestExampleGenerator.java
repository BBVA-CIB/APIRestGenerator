 ...
 * ------------------------------------------------
 */
public abstract class POMTestExampleGenerator extends GeneratorBaseFrameworkPOM
{
    /**
     ...
     */
    public POMTestExampleGenerator(final File baseDestDir,
                                    final GenerationParameters generationParams,
                                    final ParsedInfoHandler parsedInfoHandler,
                                    final String pomFileName)
    {
        super(baseDestDir, ConstantsOutputTestExample.MODULE_NAME, generationParams, parsedInfoHandler, pomFileName) ;
    }
}
