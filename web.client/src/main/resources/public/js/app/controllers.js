																   ...
																   generatorAddress)
{
	...
	$scope.generateCode = function(indexEvent, translatorType)
	{
		$scope.loggingGeneration = "" ;
		generatorService.generateTranslator(generatorAddress, loggerGenerationService.getUserId(), $scope.fileName, translatorType) ;
