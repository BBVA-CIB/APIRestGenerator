 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorClientAngular2RestBase extends TranslatorGeneratorBaseClientAngular2 implements IOperationsRest
{
	/**
	 ...
	 */
	public TranslatorGeneratorClientAngular2RestBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
