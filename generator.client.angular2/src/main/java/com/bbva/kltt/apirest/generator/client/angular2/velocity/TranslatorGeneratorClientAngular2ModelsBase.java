 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorClientAngular2ModelsBase extends TranslatorGeneratorBaseClientAngular2 implements IOperationsModel
{
	/**
	 ...
	 */
	public TranslatorGeneratorClientAngular2ModelsBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
