 ...
 * ------------------------------------------------
 */
public class ParserValuesClientAngular2Generator extends GeneratorBaseClientAngular2
{
    /**
     * Build the parser values generator
     *
     * @param baseDestDir 	    with the base destination directory for the generated file
     * @param generationParams  with the parameters for the generation for the Angular2
     * @param parsedInfoHandler	with the parsed information handler
     */
    public ParserValuesClientAngular2Generator(final File baseDestDir,
    ...
    {
    	return ConstantsOutputClientWeb.CLASSNAME_PARSER_VALUES_WEB ;
    }
}
