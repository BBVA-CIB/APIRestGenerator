 ...
 * ------------------------------------------------
 */
public class OutputLanguageItemsClientAngular2 extends OutputLanguageItems
{
	/** Attribute - Parsed information handler */
	private final IOutputLanguageNaming outputLangNaming ;
	
	/** Attribute - Title Camel Case */
	private final String titleCamelCase ;
	
	/**
	 * Public constructor
	 * @param parsedInfoHandler with the parsed information handler
	 */
	public OutputLanguageItemsClientAngular2(final ParsedInfoHandler parsedInfoHandler)
	{
		super(parsedInfoHandler) ;
		
		this.outputLangNaming = new OutputLanguageNaming() ;
		this.titleCamelCase   = this.outputLangNaming.getCamelCaseName(parsedInfoHandler.getInfoValues().getTitle()) ;
	}
	...
	{
		return this.outputLangNaming.prefixClassName(itemRef.getItemRef()) + this.titleCamelCase ;
	}
	
	@Override
	public String getTypeOutputItemComplex(final ItemComplex itemComplex)
	{
		return this.outputLangNaming.prefixClassName(itemComplex.getName()) + this.titleCamelCase ;
	}
