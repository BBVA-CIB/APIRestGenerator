 ...
 * ------------------------------------------------
 */
public class OutputParameterClientAngular2 extends OutputParameterClientWeb
{
	/**
	 * Public constructor
	 ...
	 */
	public OutputParameterClientAngular2(final Item item, final String description, final String type, final String name, final boolean autoInjected)
	{
