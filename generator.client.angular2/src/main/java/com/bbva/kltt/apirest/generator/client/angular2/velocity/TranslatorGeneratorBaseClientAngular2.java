 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorBaseClientAngular2 extends TranslatorGeneratorBaseClientWeb
{
    /**
     * Logger of the class
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TranslatorGeneratorBaseClientAngular2.class);
     ...
     */
    public TranslatorGeneratorBaseClientAngular2(final String translatorType,
                                             final GenerationParameters generationParams,
                                             final ParsedInfoHandler parsedInfoHandler)
    {
        super(translatorType, generationParams, parsedInfoHandler, ConstantsOutputClientAngular2.PACKAGE_VM_RESOURCES);
    }
    ...
    public void initializeFileDirectories() throws APIRestGeneratorException
    {
        ...
        TranslatorGeneratorBaseClientAngular2.LOGGER.info("Initializing files and creating directories with base [{}] for translator [{}]",
