...
import com.bbva.kltt.apirest.generator.client.angular2.velocity.interfaces.IOperationsUtilsClientAngular2;
 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorClientAngular2UtilsBase extends TranslatorGeneratorBaseClientAngular2 implements IOperationsUtilsClientAngular2
{
	/**
	 ...
	 */
	public TranslatorGeneratorClientAngular2UtilsBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
