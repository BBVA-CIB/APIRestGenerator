...
public abstract class PathOp
{
	 ...
	 */
	@JsonIgnore
	public boolean hasAnyResponseExceptions()
	{
		boolean hasAnyResponseException = this.operation != null && this.operation.getResponses() != null ;
		
		if (hasAnyResponseException)
		{
			hasAnyResponseException = !this.operation.getResponses().getOutboundServerExceptionsTypes().isEmpty() ;
		}
		
		return hasAnyResponseException ;
	}
	 ...
	 */
	@JsonIgnore
	public List<Response> getResponseExceptions()
	{
		return this.operation.getResponses().getOutboundServerExceptionsTypes() ;
	}
	 ...
	 */
	@JsonIgnore
	public List<Response> getOutboundServerExceptionsList()
	{
		return this.operation.getResponses().getOutboundServerExceptionsTypes() ;
	}
}
