...
public final class ConstantsInput
{
	...
	public static final String PATT_TITLE_VALID     = "[A-Za-z][A-Za-z0-9-]+" ;
	...
	private static final String[] RESER_WORDS_JAVA   = new String[]{
			"true",      "false",    "null",       "abstract", "assert",       "boolean",  "break",      "byte",
	...
	private static final String[] RESER_WORDS_TYPESC = new String[]{
	...
	private static final String[] RESER_WORDS_JAVAS = new String[]{
