 ...
 * ------------------------------------------------
 */
public class ItemSimpleFloat extends ItemNumber
{
	/**
	 * Public constructor
	 ...
	 */
	public ItemSimpleFloat(final String name, final String alias, final String description, final String required) throws APIRestGeneratorException
	{
