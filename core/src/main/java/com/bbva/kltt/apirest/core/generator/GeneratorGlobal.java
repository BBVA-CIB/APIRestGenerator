...
public class GeneratorGlobal
{
	...
	{
		// Check main errors
		this.checkMainErrors(moduleName, className) ;
	...
	/**
	 * Validate if there is any main error
	 * @throws APIRestGeneratorException exception thrown if there is a problem generating
	 */
	private void checkMainErrors(final String moduleName, final String className) throws APIRestGeneratorException
	{
