 ...
 * ------------------------------------------------
 */
public abstract class AbstractOutputException
{
	 ...
	 */
	protected AbstractOutputException(final IOutputLanguageNaming outputLanguageNaming)
	{
		this.outputLanguageNaming = outputLanguageNaming ;
	}

	/**
	 * @return the outputLanguageNaming
	 */
