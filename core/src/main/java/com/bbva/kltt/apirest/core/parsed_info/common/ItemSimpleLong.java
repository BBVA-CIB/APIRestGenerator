 ...
 * ------------------------------------------------
 */
public class ItemSimpleLong extends ItemNumber
{
	/**
	 * Public constructor
	 ...
	 */
	public ItemSimpleLong(final String name, final String alias, final String description, final String required) throws APIRestGeneratorException
	{
