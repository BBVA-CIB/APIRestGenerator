...
public abstract class OutputLanguageParameters extends OutputLanguageBase implements IOutputLanguageParameters
{
	 ...
	 */
	protected List<Parameter> getParametersList(final String pathValue, final String pathOperation)
	{
	 ...
	 */
	protected List<OutputParameter> generateOutputParameterList(List<Parameter> parameters)
	{
