...
public interface IParameterFactory
{
     ...
     */
	Parameter createNewParameter(final String inParameter,
                                 final String name,
                                 final String alias,
	...
	/**
     * @param inParameter 	   with the in parameter
	 * @param keyBodyParameter with the key of the body parameter
	 * @return true if the parameter is a body type
	 */
	boolean isBodyParameter(final String inParameter, final String keyBodyParameter) ;
	
	/**
	 * @param itemParameter with the item parameter
	 * @param item 			with the item
	 */
	void addItemIntoParameter(final Item itemParameter, final Item item) ;
}
