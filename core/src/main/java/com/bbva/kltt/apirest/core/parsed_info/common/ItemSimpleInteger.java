 ...
 * ------------------------------------------------
 */
public class ItemSimpleInteger extends ItemNumber
{
	/**
	 * Public constructor
	 ...
	 */
	public ItemSimpleInteger(final String name, final String alias, final String description, final String required) throws APIRestGeneratorException
	{
	...
	{
		return ConstantsInput.JSON_TYPE_INTEGER ;
	}
