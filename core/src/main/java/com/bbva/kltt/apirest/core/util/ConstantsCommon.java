...
public final class ConstantsCommon
{
	...
	/** String Constants - Carriage Return */
	public static final String STRING_CARRIAGE_RETURN  = "\n" ;
	/** String Constants - Square Bracket - Open */
	public static final String STRING_SQUARE_BRACKET_O = "[" ;
	/** String Constants - Square Bracket - Close */
	public static final String STRING_SQUARE_BRACKET_C = "]" ;
