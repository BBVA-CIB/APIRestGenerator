...
import com.bbva.kltt.apirest.core.parsed_info.responses.ResponseFactory;
...
public class Responses
{
	...
	/**
	 * @return a list with all the return response exception types
	 */
	@JsonIgnore
	public List<Response> getOutboundServerExceptionsTypes()
	{
		final List<Response> outcome = new ArrayList<Response>() ;
