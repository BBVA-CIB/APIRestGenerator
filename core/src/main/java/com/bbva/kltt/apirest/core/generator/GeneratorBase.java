...
import com.bbva.kltt.apirest.core.generator.output.language.IOutputLanguageExceptions;
import com.bbva.kltt.apirest.core.generator.output.language.IOutputLanguageGeneratorParams;
import com.bbva.kltt.apirest.core.generator.output.language.IOutputLanguageInfoValues;
import com.bbva.kltt.apirest.core.generator.output.language.IOutputLanguageNaming;
import com.bbva.kltt.apirest.core.generator.output.language.IOutputLanguageOperations;
import com.bbva.kltt.apirest.core.generator.output.language.IOutputLanguagePaths;
import com.bbva.kltt.apirest.core.generator.output.language.IOutputLanguageRootValues;
import com.bbva.kltt.apirest.core.generator.output.language.OutputLanguageExceptions;
import com.bbva.kltt.apirest.core.generator.output.language.OutputLanguageGeneratorParams;
import com.bbva.kltt.apirest.core.generator.output.language.OutputLanguageInfoValues;
import com.bbva.kltt.apirest.core.generator.output.language.OutputLanguageNaming;
import com.bbva.kltt.apirest.core.generator.output.language.OutputLanguageOperations;
import com.bbva.kltt.apirest.core.generator.output.language.OutputLanguagePaths;
import com.bbva.kltt.apirest.core.generator.output.language.OutputLanguageRootValues;
import com.bbva.kltt.apirest.core.generator.velocity.VelocityManager;
...
public abstract class GeneratorBase implements IGenerator
{
    ...
    /** Attribute - Output Language Exceptions */
    private final IOutputLanguageExceptions outputLanguageExceptions ;
     ...
     */
    public GeneratorBase(final File baseOutputDirectory, final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
        ...
        this.outputLanguageRootVa      = new OutputLanguageRootValues(parsedInfoHandler, this.outputLanguageNaming, this.outputLanguageGeneratorPa) ;
        ...
        this.outputLanguageExceptions  = new OutputLanguageExceptions(parsedInfoHandler, this.outputLanguageNaming, this.outputLanguageOperat) ;
    }
    ...
    protected void generateFile(final VelocityContext context) throws APIRestGeneratorException
    {
        ...
        {
        	final String errorString = "IOException while merging the template '" + templateName + "' in output file " + outputDirectoryPath ;
        	
        	GeneratorBase.LOGGER.error(errorString, ioException) ;
    ...
    protected String getFileResourceName(final String filePackage, final String fileName)
    {
        ...
        return this.getRealPath(filePackage, fileName) ;
    }
     ...
     */
    protected String getRealPath(final String filePackage, final String fileName)
    {
        ...
        {
            outcome.append(filePackageSplit[i]) ;
    ...
    {
        return this.getOutputLanguageNaming().getCamelCaseName(this.getOutputLanguageInfoValues().getTitle()) ;
    }
    ...
    private void addCommonParametersToContext(final VelocityContext context)
    {
        ...
        context.put(ConstantsOutput.COMMON_TEMP_OUT_LANG_EXCEPT,  this.getOutputLanguageExceptions()) ;
    ...
    @Override
    public IOutputLanguageExceptions getOutputLanguageExceptions()
    {
    	return this.outputLanguageExceptions ;
    }
}
