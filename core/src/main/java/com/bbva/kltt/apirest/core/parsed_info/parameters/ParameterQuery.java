 ...
 * ------------------------------------------------
 */
public class ParameterQuery extends ParameterNoBody
{
	/** Logger of the class */
    private static final Logger LOGGER = LoggerFactory.getLogger(ParameterQuery.class) ;
	 ...
	 */
	public ParameterQuery(final String name,
						  final String alias,
	...
	public void validate() throws APIRestGeneratorException
	{
		...
		{
    		String errorString = "Auto Injection is not implemented for query parameters" ;
    		
    		ParameterQuery.LOGGER.error(errorString) ;
