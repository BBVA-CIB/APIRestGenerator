...
public abstract class OutputParameters
{
	 ...
	 * @param outputParameter with the output parameter
	 */
	protected abstract void getParametersHeaderSpecific(final StringBuilder currentOutcome, final OutputParameter outputParameter) ;
	 ...
	 * @param outputParameter with the output parameter
	 */
	protected abstract void getParametersCallSpecific(final StringBuilder currentOutcome, final OutputParameter outputParameter) ;
	
	/**
	 * @return the method sign as every type separated by comma
	 */
	public String getMethodSign()
	{
		...
		if (this.parametersList != null)
		{
			for (final OutputParameter outputParam : this.parametersList)
			{
				...
				outcome.append(outputParam.getType()) ;
			}
		}
