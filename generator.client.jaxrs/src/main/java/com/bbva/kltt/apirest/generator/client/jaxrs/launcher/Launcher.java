...
package com.bbva.kltt.apirest.generator.client.jaxrs.launcher;
...
public class Launcher extends GlobalLauncher
{
    ...
    public static void main(final String[] args) throws APIRestGeneratorException
    {
        ...
        launcher.launch(args, ConstantsOutputClientJaxrs.MODULE_NAME, ConstantsOutputClientJaxrs.GENERATOR_INIT_CLASS);
    }
}
