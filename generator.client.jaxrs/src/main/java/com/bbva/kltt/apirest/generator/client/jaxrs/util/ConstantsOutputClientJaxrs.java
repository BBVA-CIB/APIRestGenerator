...
public final class ConstantsOutputClientJaxrs
{
	...
	/** Velocity Parameter - Java template - ExampleLauncherMethodsClientJaxrsTemplate */
	public static final String VP_CLI_JAXRS_EXAMPLE_TMP    = "ExampleLauncherMethodsClientJaxrsTemplate" ;
	...
	/** Velocity Parameter - Java Macro - ExampleLauncherClientJaxrsMacros */
	public static final String VP_CLI_JAXRS_EXAMPLE_MACROS = "ExampleLauncherClientJaxrsMacros" ;
	...
	public static final String PACKAGE_VM_RESOURCES			= "com.bbva.apirest.kltt.generator.client.jaxrs.velocity" ;

	/** Name of the module */
	public static final String MODULE_NAME					= "client.jaxrs";
