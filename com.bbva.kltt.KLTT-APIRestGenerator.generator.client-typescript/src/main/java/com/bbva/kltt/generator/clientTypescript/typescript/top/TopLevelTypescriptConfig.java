...
package com.bbva.kltt.generator.clientTypescript.typescript.top;
...
/**
 * Generate the top level Typescript compilator
 * ------------------------------------------------
 * @author Francisco Manuel Benitez Chico
 * ------------------------------------------------
 */
public class TopLevelTypescriptConfig extends GeneratorBase
{
    /**
     ...
     */
    public TopLevelTypescriptConfig(final File baseDestDir,
    ...
    {
        return ConstantsOutputTypescript.VEL_TYPESCRIPT_CFG_FILE_NAME;
    }
