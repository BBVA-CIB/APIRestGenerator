 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorTypescriptModelsBase extends TranslatorGeneratorBaseTypescript implements IOperationsModel
{
	/**
	 ...
	 */
	public TranslatorGeneratorTypescriptModelsBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
