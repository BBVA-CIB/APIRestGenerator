...
import com.bbva.kltt.generator.clientTypescript.typescript.interfaces.IOperationsUtilsTypescript;
 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorTypescriptUtilsBase extends TranslatorGeneratorBaseTypescript implements IOperationsUtilsTypescript
{
	/**
	 ...
	 */
	public TranslatorGeneratorTypescriptUtilsBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
