 ...
 * ------------------------------------------------
 */
public class ParserValuesTypescriptGenerator extends GeneratorBaseTypescript
{
    /**
     ...
     */
    public ParserValuesTypescriptGenerator(final File baseDestDir,
    ...
    {
        return ConstantsOutputTypescript.CLASSNAME_PARSER_VALUES_TS ;
    }
}
