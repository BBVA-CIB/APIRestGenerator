 ...
 * ------------------------------------------------
 */
public class OutputParametersTypescript extends OutputParameters
{
	/**
	 * Public constructor
	 ...
	 */
	public OutputParametersTypescript(final IOutputLanguageSeparators outputLangSeparators, final List<OutputParameter> outputParamsList)
	{
