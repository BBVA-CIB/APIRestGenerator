...
import com.bbva.kltt.core.generator.output.language.IOutputLanguageNaming;
import com.bbva.kltt.core.generator.output.language.OutputLanguageItems;
import com.bbva.kltt.core.generator.output.language.OutputLanguageNaming;
 ...
 * ------------------------------------------------
 */
public class OutputLanguageItemsTypescript extends OutputLanguageItems
{
	 ...
	 */
	public OutputLanguageItemsTypescript(final ParsedInfoHandler parsedInfoHandler)
	{
	...
	{
		return ConstantsOutputTypescript.TYPESCRIPT_TYPE_BOOLEAN ;
	}

	@Override
	public String getTypeOutputSimpleInteger(final boolean isArrayBaseType)
	{
		return ConstantsOutputTypescript.TYPESCRIPT_TYPE_NUMBER ;
	}
	...
	{
		return ConstantsOutputTypescript.TYPESCRIPT_TYPE_STRING ;
	}
	...
	{
		return ConstantsOutputTypescript.TYPESCRIPT_TYPE_FILE ;
	}
