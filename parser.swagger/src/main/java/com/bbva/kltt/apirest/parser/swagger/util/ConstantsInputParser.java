...
public final class ConstantsInputParser
{
	...
	/** SWAGGER - Common for definition or parameters - Specific BBVA ***/	
	
	/** Swagger - Common attribute - alias - obsoleted */
	public static final String SW_COMMON_ALIAS_OBSO = "alias" ;
	/** Swagger - Common attribute - alias */
	public static final String SW_COMMON_ALIAS_BBVA = "x-alias" ;
	...
	/************** SWAGGER - Parameters - Specific BBVA ******************/
	
	/** Swagger - Parameters - auto injected - Specific BBVA */
	public static final String SW_PARAM_AUTOIN_BBVA = "x-auto-injected" ;
