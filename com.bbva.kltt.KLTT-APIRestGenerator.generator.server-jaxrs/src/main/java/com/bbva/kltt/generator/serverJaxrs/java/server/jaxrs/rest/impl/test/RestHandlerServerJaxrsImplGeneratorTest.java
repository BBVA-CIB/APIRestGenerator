 ...
 * ------------------------------------------------
 */
public class RestHandlerServerJaxrsImplGeneratorTest extends GeneratorBaseServerJaxrs
{
    /**
     ...
     */
    public RestHandlerServerJaxrsImplGeneratorTest(final File baseDestDir,
