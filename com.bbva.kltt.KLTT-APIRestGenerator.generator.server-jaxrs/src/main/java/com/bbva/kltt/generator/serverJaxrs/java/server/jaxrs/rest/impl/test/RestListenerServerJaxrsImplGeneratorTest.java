...
package com.bbva.kltt.generator.serverJaxrs.java.server.jaxrs.rest.impl.test;
 ...
 * ------------------------------------------------
 */
public class RestListenerServerJaxrsImplGeneratorTest extends GeneratorBaseServerJaxrs
{
	/**
     ...
     */
    public RestListenerServerJaxrsImplGeneratorTest(final File baseDestDir,
    ...
    {
        return ConstantsOutput.CLASSNAME_REST_LISTENER_TES ;
    }
}
