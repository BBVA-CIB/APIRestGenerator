...
import com.bbva.kltt.core.parsed_info.parameters.ParameterPath;
...
public class PathsParserPostValidator
{
													...
													final String pathOpType) throws APIRestGeneratorException
	{
		...
		for (final String pendingPathValue : pendingPathValues)
		{
			...
			{
				pendingPathValString = pendingPathValue + ConstantsCommon.STRING_COMMA + ConstantsCommon.STRING_BLANK + pendingPathValString ;
			}
		}
		
		final String errorString = "The path '" + pathValue + "' has the following missed path values in the '" + pathOpType + "' operation: " + pendingPathValString ;
											...
											final boolean hasAnyParameterPathFormData) throws APIRestGeneratorException
	{
		...
		if ((hasAnyParameterOpBody     && hasAnyParameterOpFormData)   || 
			(hasAnyParameterOpBody     && hasAnyParameterPathFormData) || 
			(hasAnyParameterOpFormData && hasAnyParameterPathBody))
		{
	...
	{
		final String errorString = "The path '" + pathValue + "' cannot have body and formData parameters together in the common path parameters" ;
	...
	{
		final String errorString = "The path '" + pathValue + "' cannot have body and formData parameters together in the '" + pathOp.getPathOpType() + "' operation" ;
	...
	{
		final String errorString = "The path '" + pathValue + "' cannot multiple body parameters in the '" + pathOp.getPathOpType() + "' operation" ;
