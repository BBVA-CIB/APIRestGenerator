 ...
 * ------------------------------------------------
 */
public class RestHandlerClientFeignInterfaceGenerator extends GeneratorBaseClientFeign
{
    /**
     ...
     */
    public RestHandlerClientFeignInterfaceGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        context.put(ConstantsOutputClientFeign.VP_INT_NAME_HYSTRIX_FALLBACK, ConstantsOutputClientFeign.INTERF_NAME_HYSTRIX_FALLBACK +
                															 this.getTitleCamelCase()) ;
        context.put(ConstantsOutputClientFeign.VP_REM_SERV_NAME_YAML_PARAM, ConstantsOutputClientFeign.REMOTE_SERV_NAME_YAML_PARAM +
                                                                            this.getTitleCamelCase() + ConstantsCommon.STRING_BRACKETS_CLOSE) ;


        // Java Templates
        context.put(ConstantsOutputJava.VP_JAVA_TEMPL_METH_COMMENTS,
        			this.getCommonJavaResourcePath(ConstantsOutputJava.COMMON_JAVA_DIR_TEMPLATES,
        ...
        // Feign Templates
        context.put(ConstantsOutputClientFeign.VP_FEI_TEMPL_REST_MET_HEA_IN,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputClientFeign.VP_FEI_TEMPL_REST_MET_HEA_IN)) ;
    ...
    {
        return ConstantsOutputJava.INTERFACE_NAME_REST_HANDLER + this.getTitleCamelCase() ;
    }
}
