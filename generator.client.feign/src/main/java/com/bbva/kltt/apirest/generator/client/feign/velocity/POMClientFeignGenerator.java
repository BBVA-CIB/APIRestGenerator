 ...
 * ------------------------------------------------
 */
public abstract class POMClientFeignGenerator extends GeneratorBaseFrameworkPOM
{
    /**
     ...
     */
    public POMClientFeignGenerator(final File baseDestDir,
                                       final GenerationParameters generationParams,
                                       final ParsedInfoHandler parsedInfoHandler,
                                       final String pomFileName)
    {
        super(baseDestDir, ConstantsOutputClientFeign.MODULE_NAME, generationParams, parsedInfoHandler, pomFileName) ;
    }
}
