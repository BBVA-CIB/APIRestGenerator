...
package com.bbva.kltt.apirest.generator.client.feign.launcher;
...
/**
 * Launcher for code generations (Feign)
 * ------------------------------------------------
...
public class Launcher extends GlobalLauncher
{
    ...
    public static void main(final String[] args) throws APIRestGeneratorException
    {
        ...
        launcher.launch(args, ConstantsOutputClientFeign.MODULE_NAME, ConstantsOutputClientFeign.GENERATOR_INIT_CLASS) ;
    }
}
