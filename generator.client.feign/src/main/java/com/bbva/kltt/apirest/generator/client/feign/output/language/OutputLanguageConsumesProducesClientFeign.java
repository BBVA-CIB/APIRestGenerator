 ...
 * ------------------------------------------------
 */
public class OutputLanguageConsumesProducesClientFeign extends OutputLanguageConsumesProduces
{
	/**
	 * Public constructor
	 * @param parsedInfoHandler with the parsed information handler
	 */
	public OutputLanguageConsumesProducesClientFeign(final ParsedInfoHandler parsedInfoHandler)
	{
	...
	{
		return ConstantsCommon.STRING_BRACKETS_OPEN ;
	}

	@Override
	public String generateFinalConsumesOrProducesString()
	{
		return ConstantsCommon.STRING_BRACKETS_CLOSE ;
	}
}
