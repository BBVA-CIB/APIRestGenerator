 ...
 * ------------------------------------------------
 */
public class HystrixFallbackClientFeignImplGenerator extends GeneratorBaseClientFeign
{
    /**
     ...
     */
    public HystrixFallbackClientFeignImplGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        context.put(ConstantsOutputClientFeign.VP_INT_NAME_HYSTRIX_FALLBACK, ConstantsOutputClientFeign.INTERF_NAME_HYSTRIX_FALLBACK + this.getTitleCamelCase()) ;
        ...
        // Feign Templates
        context.put(ConstantsOutputClientFeign.VP_FEI_TEMPL_HYST_MET_HEA_IM,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputClientFeign.VP_FEI_TEMPL_HYST_MET_HEA_IM)) ;
	...
	private List<String> generateAdditionalImports()
	{
		...
		// Hystrix interface - import
		additionalImports.add(this.generateImportHystrixInterface(this.getTranslatorType())) ;
    ...
    {
        return ConstantsOutputClientFeign.CLASS_NAME_HYSTRIX_FALLBACK + this.getTitleCamelCase() ;
    }
}
