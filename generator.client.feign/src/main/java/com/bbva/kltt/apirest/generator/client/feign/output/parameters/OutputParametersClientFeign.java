...
package com.bbva.kltt.apirest.generator.client.feign.output.parameters;
 ...
 * ------------------------------------------------
 */
public class OutputParametersClientFeign extends OutputParametersJava
{
	/**
	 * Public constructor
	 ...
	 */
	public OutputParametersClientFeign(final IOutputLanguageSeparators outputLangSeparators, final List<OutputParameter> outputParamsList)
	{
