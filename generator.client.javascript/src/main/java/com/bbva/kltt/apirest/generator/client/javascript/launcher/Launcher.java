...
package com.bbva.kltt.apirest.generator.client.javascript.launcher;
...
/**
 * Launcher for code generations (Javascript)
 * ------------------------------------------------
...
public class Launcher extends GlobalLauncher
{
    ...
    public static void main(final String[] args) throws APIRestGeneratorException
    {
        ...
        launcher.launch(args, ConstantsOutputClientJavascript.MODULE_NAME, ConstantsOutputClientJavascript.GENERATOR_INIT_CLASS);
    }
}
