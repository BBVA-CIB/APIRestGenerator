...
package com.bbva.kltt.apirest.generator.client.javascript.velocity.models;
...
import com.bbva.kltt.apirest.generator.client.javascript.velocity.TranslatorGeneratorClientJavascriptModelsBase;
 ...
 * ------------------------------------------------
 */
public class TranslatorGeneratorClientJavascriptModels extends TranslatorGeneratorClientJavascriptModelsBase
{
    /**
     * Logger of the class
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TranslatorGeneratorClientJavascriptModels.class);
     ...
     */
    public TranslatorGeneratorClientJavascriptModels(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
    ...
    public void generateModels(final File destDir) throws APIRestGeneratorException
    {
        ...
        TranslatorGeneratorClientJavascriptModels.LOGGER.info("Generating the JavaScript definition classes and subclasses");
        ...
        for (final Entry<String, Item> entry : this.definitionsMap.entrySet())
        {
            ...
            {
                definitionsGenerator = new ModelsComplexClientJavascriptGenerator(destDir,
            ...
            {
                definitionsGenerator = new ModelsRefClientJavascriptGenerator(destDir,
                                                                        this.getGenerationParams(),
                                                                        this.getParsedInfoHandler(),
                                                                        className,
                                                                        (ItemRef) item);
        ...
        TranslatorGeneratorClientJavascriptModels.LOGGER.info("Generated the JavaScript definition classes and subclasses");
    }
