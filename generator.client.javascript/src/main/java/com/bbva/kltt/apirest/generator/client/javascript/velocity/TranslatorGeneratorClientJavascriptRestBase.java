 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorClientJavascriptRestBase extends TranslatorGeneratorBaseClientJavascript implements IOperationsRest
{
	/**
	 ...
	 */
	public TranslatorGeneratorClientJavascriptRestBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
