...
import com.bbva.kltt.apirest.generator.client.javascript.velocity.interfaces.IOperationsExampleClientJavascript;
 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorClientJavascriptExampleBase extends TranslatorGeneratorBaseClientJavascript implements IOperationsExampleClientJavascript
{
    /**
     * Logger of the class
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TranslatorGeneratorClientJavascriptExampleBase.class);
     ...
     */
    public TranslatorGeneratorClientJavascriptExampleBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
    ...
    public void initializeFileDirectories() throws APIRestGeneratorException
    {
        ...
        TranslatorGeneratorClientJavascriptExampleBase.LOGGER.info("Initializing files and creating directories with base [{}] for translator [{}] for the examples",
