 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorClientJavascriptModelsBase extends TranslatorGeneratorBaseClientJavascript implements IOperationsModel
{
	/**
	 ...
	 */
	public TranslatorGeneratorClientJavascriptModelsBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
