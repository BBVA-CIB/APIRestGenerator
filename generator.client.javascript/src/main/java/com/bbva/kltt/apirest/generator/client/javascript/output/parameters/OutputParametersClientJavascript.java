 ...
 * ------------------------------------------------
 */
public class OutputParametersClientJavascript extends OutputParameters
{
	/**
	 * Public constructor
	 ...
	 */
	public OutputParametersClientJavascript(final IOutputLanguageSeparators outputLangSeparators, final List<OutputParameter> outputParamsList)
	{
