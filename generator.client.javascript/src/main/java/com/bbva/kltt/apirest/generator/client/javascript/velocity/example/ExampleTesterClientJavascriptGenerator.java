 ...
 * ------------------------------------------------
 */
public class ExampleTesterClientJavascriptGenerator extends GeneratorBaseClientJavascript
{
    /**
     ...
     */
    public ExampleTesterClientJavascriptGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        context.put(ConstantsOutputClientJavascript.VP_REST_HANDLER_FILE,
        ...
        context.put(ConstantsOutputClientJavascript.VP_REST_LISTENER_FILE,
                    ConstantsOutput.DIRECTORY_BACK_ONE 	   + ConstantsOutputClientWeb.WEB_GENERATED_FOLDER + ConstantsCommon.STRING_SLASH +
                    ConstantsOutput.FOLDER_REST			   + ConstantsCommon.STRING_SLASH 								 			+
        ...
        // Templates
        context.put(ConstantsOutputClientJavascript.VP_JS_TEMPL_EXA_TEST_MET,
                	this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputClientJavascript.VP_JS_TEMPL_EXA_TEST_MET));

        // Macros
        context.put(ConstantsOutputClientJavascript.VP_JS_MACRO_COMMON,
                	this.getTemplateResourceName(ConstantsOutput.DIRECTORY_BACK_ONE, ConstantsOutputClientJavascript.VP_JS_MACRO_COMMON));

        context.put(ConstantsOutputClientJavascript.VP_JS_MACRO_EXAMPLE_TEST,
                	this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputClientJavascript.VP_JS_MACRO_EXAMPLE_TEST));
