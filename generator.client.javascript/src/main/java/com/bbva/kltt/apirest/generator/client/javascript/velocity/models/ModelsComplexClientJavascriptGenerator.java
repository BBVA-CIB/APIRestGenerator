 ...
 * ------------------------------------------------
 */
public class ModelsComplexClientJavascriptGenerator extends GeneratorBaseClientJavascript
{
     ...
     */
    public ModelsComplexClientJavascriptGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        context.put(ConstantsOutputClientJavascript.VP_JS_MACRO_MOD_COMPLEX,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputClientJavascript.VP_JS_MACRO_MOD_COMPLEX)) ;
