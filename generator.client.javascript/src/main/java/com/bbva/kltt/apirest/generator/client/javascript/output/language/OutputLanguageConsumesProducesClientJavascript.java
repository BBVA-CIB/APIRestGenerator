 ...
 * ------------------------------------------------
 */
public class OutputLanguageConsumesProducesClientJavascript extends OutputLanguageConsumesProduces
{
	/**
	 * Public constructor
	 * @param parsedInfoHandler with the parsed information handler
	 */
	public OutputLanguageConsumesProducesClientJavascript(final ParsedInfoHandler parsedInfoHandler)
	{
	...
	{
		// There is only one consumes in JavaScript, then this delimiter is empty
