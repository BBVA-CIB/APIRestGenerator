...
import com.bbva.kltt.apirest.generator.client.javascript.output.parameters.OutputParameterClientJavascript;
import com.bbva.kltt.apirest.generator.client.javascript.output.parameters.OutputParametersClientJavascript;
 ...
 * ------------------------------------------------
 */
public class OutputLanguageParametersClientJavascript extends OutputLanguageParametersClientWeb
{
	 ...
	 */
	public OutputLanguageParametersClientJavascript(final ParsedInfoHandler parsedInfoHandler)
	{
		super(parsedInfoHandler, new OutputLanguageSeparatorsClientJavascript()) ;
	...
	{
		return new OutputParametersClientJavascript(this.getOutputLangSeparators(), outputParamList) ;
	}
	...
	public OutputParameter createNewOutputParameter(final Parameter parameter)
	{
		...
		return new OutputParameterClientJavascript(parameter.getItem(),
