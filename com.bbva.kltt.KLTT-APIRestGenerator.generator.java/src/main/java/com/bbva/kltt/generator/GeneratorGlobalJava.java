...
package com.bbva.kltt.generator;
...
import com.bbva.kltt.generator.java.models.TranslatorGeneratorJavaModels;
import com.bbva.kltt.generator.java.top.MvnInstallFileLinuxGenerator;
import com.bbva.kltt.generator.java.top.MvnInstallFileWindowsGenerator;
import com.bbva.kltt.generator.java.top.TopLevelJavaPOM;
...
public abstract class GeneratorGlobalJava extends GeneratorGlobalLanguage
{
    ...
    protected IGenerator generateInstanceTopLevelPOM(final File topLevelPomDir,
                                                     ...
                                                     final String generationPackage)
    {
        return new TopLevelJavaPOM(topLevelPomDir, translatorName, genParams, parsedInfoHandler, pomFileName, generationPackage);
    }
