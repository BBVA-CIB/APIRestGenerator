...
import com.bbva.kltt.generator.java.models.output.language.OutputLanguageItemsModels;
...
public abstract class GeneratorBaseJavaModels extends GeneratorBaseJava
{
     ...
     */
    public GeneratorBaseJavaModels(final File baseDestDir,
                                   ...
                                   final String generationPackage)
    {
        ...
        this.outputLanguageItems = new OutputLanguageItemsModels(parsedInfoHandler);
    }
