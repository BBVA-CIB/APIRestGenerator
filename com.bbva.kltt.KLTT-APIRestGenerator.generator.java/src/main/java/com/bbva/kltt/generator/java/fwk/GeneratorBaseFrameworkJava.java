...
import com.bbva.kltt.generator.java.GeneratorBaseJava;
...
public abstract class GeneratorBaseFrameworkJava extends GeneratorBaseJava
{
     ...
     * @param generationPackage with the generator module package
     */
    public GeneratorBaseFrameworkJava(final File baseDestDir,
