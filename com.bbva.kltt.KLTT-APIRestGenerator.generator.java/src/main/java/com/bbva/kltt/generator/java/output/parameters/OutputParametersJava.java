...
package com.bbva.kltt.generator.java.output.parameters;
...
public abstract class OutputParametersJava extends OutputParameters
{
	 ...
	 */
	protected abstract void getParametersHeaderRestSpecific(final StringBuffer currentOutcome, final OutputParameter outputParameter) ;
	 ...
	 * @param outputParameter with the output parameter
	 */
	protected abstract void getParametersTestSpecific(final StringBuffer currentOutcome, final OutputParameter outputParameter) ;
}
