...
public interface ILauncher
{
	 ...
	 * @param moduleName 		   name of type parser
	 * @return the parsedInfo
	 * @throws APIRestGeneratorException exception thrown if there is any problem during the process
	 */
	IParser getSchemasParser(final GenerationParameters generationParameters, final String moduleName) throws APIRestGeneratorException ;
}
