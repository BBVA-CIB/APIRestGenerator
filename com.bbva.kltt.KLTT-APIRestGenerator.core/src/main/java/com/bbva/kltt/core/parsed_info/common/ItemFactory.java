...
public class ItemFactory implements IItemFactory
{
	...
	{
		return type == null 										   || 
			   type.equalsIgnoreCase(ConstantsInput.JSON_TYPE_STRING)  || 
			   type.equalsIgnoreCase(ConstantsInput.JSON_TYPE_BOOLEAN) || 
			   type.equalsIgnoreCase(ConstantsInput.JSON_TYPE_INTEGER) || 
			   type.equalsIgnoreCase(ConstantsInput.JSON_TYPE_NUMBER) ;
	}
						   	  		...
						   	  		final String format) throws APIRestGeneratorException
	{
		...
		else if (type.equalsIgnoreCase(ConstantsInput.JSON_TYPE_NUMBER) && (format == null || format.equalsIgnoreCase(ConstantsInput.JSON_FORMAT_FLOAT)))
		{
