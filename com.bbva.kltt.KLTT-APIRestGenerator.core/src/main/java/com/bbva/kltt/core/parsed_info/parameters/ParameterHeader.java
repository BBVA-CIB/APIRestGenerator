 ...
 * ------------------------------------------------
 */
public class ParameterHeader extends ParameterNoBody
{
	/**
	 * Public constructor
	 ...
	 */
	public ParameterHeader(final String name, final String alias, final String description, final String required, final String type) throws APIRestGeneratorException
	{
