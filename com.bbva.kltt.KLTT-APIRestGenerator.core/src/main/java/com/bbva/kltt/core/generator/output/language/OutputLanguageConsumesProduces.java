...
public abstract class OutputLanguageConsumesProduces extends OutputLanguageBase implements IOutputLanguageConsumesProduces
{
	...
	{
		final StringBuffer stringBuffer = new StringBuffer(this.generateInitialConsumesOrProducesString()) ;
		...
		stringBuffer.append(this.outputLangSeparators.generateStringDelimiter()) ;
		stringBuffer.append(sources.iterator().next()) ;
		stringBuffer.append(this.outputLangSeparators.generateStringDelimiter()) ;
		
//		for (final String source : sources)
//		{
//			if (!this.generateInitialConsumesOrProducesString().equals(stringBuffer.toString()))
//			{
//				stringBuffer.append(this.outputLangSeparators.generateSeparatorValues()) ;
//			}
//			
//			stringBuffer.append(this.outputLangSeparators.generateStringDelimiter()) ;
...
//		}
		...
		stringBuffer.append(this.generateFinalConsumesOrProducesString()) ;
