...
public class ParameterBody extends Parameter
{
	 ...
	 */
	public ParameterBody(final String name, final String alias, final String description, final String required, final String type) throws APIRestGeneratorException
	{
