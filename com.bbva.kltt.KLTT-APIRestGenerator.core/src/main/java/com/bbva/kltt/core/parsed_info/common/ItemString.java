 ...
 * ------------------------------------------------
 */
public abstract class ItemString extends Item
{
	/** Attribute - pattern */
	 ...
	 */
	protected ItemString(final String name, final String alias, final String description, final String required) throws APIRestGeneratorException
	{
