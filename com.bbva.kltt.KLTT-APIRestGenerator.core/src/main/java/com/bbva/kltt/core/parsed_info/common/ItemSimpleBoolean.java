 ...
 * ------------------------------------------------
 */
public class ItemSimpleBoolean extends Item
{
	/**
	 * Public constructor
	 ...
	 */
	public ItemSimpleBoolean(final String name, final String alias, final String description, final String required) throws APIRestGeneratorException
	{
	...
	{
		return ConstantsInput.JSON_TYPE_BOOLEAN ;
	}
