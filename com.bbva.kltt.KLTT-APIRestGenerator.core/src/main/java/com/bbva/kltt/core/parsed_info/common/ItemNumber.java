 ...
 * ------------------------------------------------
 */
public abstract class ItemNumber extends Item
{
	/** Attribute - maximum */
	 ...
	 */
	protected ItemNumber(final String name, final String alias, final String description, final String required) throws APIRestGeneratorException
	{
