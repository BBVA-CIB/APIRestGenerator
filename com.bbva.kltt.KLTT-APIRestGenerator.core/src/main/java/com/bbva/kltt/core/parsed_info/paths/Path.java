...
import com.bbva.kltt.core.parsed_info.parameters.ParameterBody;
...
public class Path
{
	...
	{
		return this.getPathOp(pathOperation).hasAnyScheme() ;
	}
	...
	{
		return this.getPathOp(pathOperation).getSchemes() ;
	}
	...
	{
		return this.getPathOp(pathOperation).getOperationId() ;
	}
	...
	{
		return this.getPathOp(pathOperation).getOutboundServerItemType() ;
	}
	...
	{
		return this.getPathOp(pathOperation).getConsumes() ;
	}
	...
	{
		return this.getPathOp(pathOperation).getProduces() ;
	}
