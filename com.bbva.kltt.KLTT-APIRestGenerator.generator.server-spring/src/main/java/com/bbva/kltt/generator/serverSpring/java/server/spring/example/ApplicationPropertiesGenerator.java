...
public class ApplicationPropertiesGenerator extends GeneratorBase
{
     ...
     */
	public ApplicationPropertiesGenerator(final File baseDestDir,
	...
	public VelocityContext createVelocityContext()
	{
		...
		context.put(ConstantsOutputServerSpring.VP_SPR_PORT_NUMBER, this.getOutputLanguageRootValues().getOnlyPort()) ;
	...
	{
		return ConstantsOutputServerSpring.APP_PROPERTIES_FILE_NAME ;
	}
