 ...
 * ------------------------------------------------
 */
public class RestPOMServerSpringInterfaceGenerator extends POMServerSpringGenerator
{
    /**
     ...
     */
	public RestPOMServerSpringInterfaceGenerator(final File baseDestDir,
