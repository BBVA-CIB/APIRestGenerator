...
package com.bbva.kltt.generator.serverSpring.java.server.spring;
...
import com.bbva.kltt.generator.serverSpring.java.server.spring.output.language.OutputLanguageConsumesProducesServerSpring;
import com.bbva.kltt.generator.serverSpring.java.server.spring.output.language.OutputLanguageItemsServerSpring;
import com.bbva.kltt.generator.serverSpring.java.server.spring.output.language.OutputLanguageParametersServerSpring;
...
public abstract class GeneratorBaseServerSpring extends GeneratorBaseFrameworkJava
{
     ...
     */
    public GeneratorBaseServerSpring(final File baseDestDir,
									 final GenerationParameters generationParams,
									 final ParsedInfoHandler parsedInfoHandler)
    {
        super(baseDestDir, generationParams, parsedInfoHandler, ConstantsOutputServerSpring.PACKAGE_VM_RESOURCES) ;
