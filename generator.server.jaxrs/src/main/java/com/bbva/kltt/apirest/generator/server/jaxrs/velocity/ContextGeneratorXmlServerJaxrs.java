 ...
 * ------------------------------------------------
 */
public abstract class ContextGeneratorXmlServerJaxrs extends GeneratorBaseFrameworkJava
{
    /**
     * Builds a new Base XML Generator
     *
     ...
     */
    public ContextGeneratorXmlServerJaxrs(final File baseDestDir,
    ...
    {
        return ConstantsOutputServerJaxrs.XML_FOLDERS;
    }

    @Override
    protected String getOutputExtension()
    {
        return ConstantsCommon.STRING_DOT + ConstantsCommon.EXTENSION_XML;
    }
