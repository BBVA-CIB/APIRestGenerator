...
package com.bbva.kltt.apirest.generator.server.jaxrs.velocity.rest.impl;
...
import com.bbva.kltt.apirest.generator.server.jaxrs.velocity.rest.impl.test.RestHandlerServerJaxrsImplGeneratorTest;
import com.bbva.kltt.apirest.generator.server.jaxrs.velocity.rest.impl.test.RestListenerServerJaxrsImplGeneratorTest;
import com.bbva.kltt.apirest.generator.server.jaxrs.velocity.rest.impl.xml.RestContextOsgiXmlServerJaxrsImplGenerator;
import com.bbva.kltt.apirest.generator.server.jaxrs.velocity.rest.impl.xml.RestContextXmlServerJaxrsImplGenerator;
...
public class TranslatorGeneratorServerJaxrsImplRest extends TranslatorGeneratorJavaRestImplBase
{
	...
	{
    	return FilesUtility.loadFileContentFromClasspath(ConstantsOutputServerJaxrs.PROJECT_NAME + ConstantsCommon.STRING_DOT + ConstantsOutput.EXTENSION_PROPERTIES) ;
	}
}
