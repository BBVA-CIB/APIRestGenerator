...
package com.bbva.kltt.apirest.generator.server.jaxrs.velocity.rest.interfaces;
 ...
 * ------------------------------------------------
 */
public class RestHandlerServerJaxrsInterfaceGenerator extends GeneratorBaseServerJaxrs
{
    /**
     ...
     */
    public RestHandlerServerJaxrsInterfaceGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        // JAX-RS Templates
        context.put(ConstantsOutputServerJaxrs.VP_SER_JAXRS_T_REST_M_H_INT,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY,
                                                 ConstantsOutputServerJaxrs.VP_SER_JAXRS_T_REST_M_H_INT)) ;
