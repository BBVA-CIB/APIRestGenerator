...
package com.bbva.kltt.apirest.generator.server.jaxrs.util;
...
public final class ConstantsOutputServerJaxrs
{
	...
	public static final String PACKAGE_VM_RESOURCES			= "com.bbva.kltt.apirest.generator.server.jaxrs.velocity" ;

	/** Name of the module */
	public static final String MODULE_NAME					= "server.jaxrs";
