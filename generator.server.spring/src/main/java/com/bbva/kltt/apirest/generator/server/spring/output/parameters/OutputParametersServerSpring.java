 ...
 * ------------------------------------------------
 */
public class OutputParametersServerSpring extends OutputParametersJava
{
	/**
	 * Public constructor
	 ...
	 */
	public OutputParametersServerSpring(final IOutputLanguageSeparators outputLangSeparators, final List<OutputParameter> outputParamsList)
	{
