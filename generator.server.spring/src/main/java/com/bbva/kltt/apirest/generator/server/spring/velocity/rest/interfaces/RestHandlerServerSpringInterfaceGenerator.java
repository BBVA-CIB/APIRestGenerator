 ...
 * ------------------------------------------------
 */
public class RestHandlerServerSpringInterfaceGenerator extends GeneratorBaseServerSpring
{
    /**
     ...
     */
    public RestHandlerServerSpringInterfaceGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        // Spring Templates
        context.put(ConstantsOutputServerSpring.VP_SPR_TEMPL_REST_MET_HEA_IN,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY, ConstantsOutputServerSpring.VP_SPR_TEMPL_REST_MET_HEA_IN)) ;
