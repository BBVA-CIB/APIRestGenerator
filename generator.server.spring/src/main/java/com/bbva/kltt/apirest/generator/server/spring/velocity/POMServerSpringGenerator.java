...
import com.bbva.kltt.apirest.generator.java.velocity.fwk.GeneratorBaseFrameworkPOM;
 ...
 * ------------------------------------------------
 */
public abstract class POMServerSpringGenerator extends GeneratorBaseFrameworkPOM
{
    /**
     ...
     */
    public POMServerSpringGenerator(final File baseDestDir,
                                    final GenerationParameters generationParams,
                                    final ParsedInfoHandler parsedInfoHandler,
                                    final String pomFileName)
    {
        super(baseDestDir, ConstantsOutputServerSpring.MODULE_NAME, generationParams, parsedInfoHandler, pomFileName) ;
    }
}
