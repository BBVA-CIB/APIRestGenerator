...
package com.bbva.kltt.apirest.generator.server.spring.launcher;
...
public class Launcher extends GlobalLauncher
{
    ...
    public static void main(final String[] args) throws APIRestGeneratorException
    {
        ...
        launcher.launch(args, ConstantsOutputServerSpring.MODULE_NAME, ConstantsOutputServerSpring.GENERATOR_INIT_CLASS) ;
    }
}
