...
import com.bbva.kltt.apirest.generator.server.spring.output.parameters.OutputParameterServerSpring;
import com.bbva.kltt.apirest.generator.server.spring.output.parameters.OutputParametersServerSpring;
 ...
 * ------------------------------------------------
 */
public class OutputLanguageParametersServerSpring extends OutputLanguageParametersJava
{
	/**
	 * Public constructor
	...
	private String getAnnotation(final Parameter parameter)
	{
		...
		{
			annotationName = ConstantsOutputServerSpring.SPRING_ANN_REQUEST_BODY ;
		}
		else if (parameter instanceof ParameterFormData || parameter instanceof ParameterQuery)
		{
			annotationName = ConstantsOutputServerSpring.SPRING_ANN_REQUEST_PARAM ;
		}
		else if (parameter instanceof ParameterHeader)
		{
			annotationName = ConstantsOutputServerSpring.SPRING_ANN_REQUEST_HEADER ;
		}
		else if (parameter instanceof ParameterPath)
		{
			annotationName = ConstantsOutputServerSpring.SPRING_ANN_PATH_VARIABLE ;
		}
	...
	protected String getAnnotationParams(final String aliasName, final boolean required, final String annotationName)
	{
		...
		boolean valueAnnotationFilled = !ConstantsOutputServerSpring.SPRING_ANN_REQUEST_BODY.equals(annotationName) ;
		...
		if (!ConstantsOutputServerSpring.SPRING_ANN_PATH_VARIABLE.equals(annotationName))
		{
