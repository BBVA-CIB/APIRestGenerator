 ...
 * ------------------------------------------------
 */
public class OutputLanguageConsumesProducesClientJaxrs extends OutputLanguageConsumesProduces
{
	/**
	 * Public constructor
	 * @param parsedInfoHandler with the parsed information handler
	 */
	public OutputLanguageConsumesProducesClientJaxrs(final ParsedInfoHandler parsedInfoHandler)
	{
