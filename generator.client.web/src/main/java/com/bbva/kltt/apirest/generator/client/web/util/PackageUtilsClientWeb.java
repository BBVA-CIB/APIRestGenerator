 ...
 * ------------------------------------------------
 */
public class PackageUtilsClientWeb extends PackageUtils
{
	/** Attribute - Project version */
	 ...
	 */
	public PackageUtilsClientWeb(final String businessUnit, final String projectTitle, final String projectVersion)
	{
    ...
    /**
     * @return the project version suffix
     */
    public String getProjectVersionSuffix()
    {
    	return ConstantsCommon.STRING_UNDERSCORE + this.projectVersion ;
    }
}
