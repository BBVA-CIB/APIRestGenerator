...
package com.bbva.kltt.apirest.generator.test.example.velocity.top;
 ...
 * ------------------------------------------------
 */
public class TopLevelTestExampleConfig extends GeneratorBase
{
    /**
     ...
     */
    public TopLevelTestExampleConfig(final File baseDestDir, final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
