...
import com.bbva.kltt.apirest.generator.test.example.velocity.interfaces.IOperationsUtilsTestExample;
 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorTestExampleUtilsBase extends TranslatorGeneratorBaseTestExample implements IOperationsUtilsTestExample
{
	/**
	 ...
	 */
	public TranslatorGeneratorTestExampleUtilsBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
