...
import com.bbva.kltt.apirest.generator.test.example.velocity.interfaces.IOperationsExampleTestExample;
 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorTestExampleExampleBase extends TranslatorGeneratorBaseTestExample implements IOperationsExampleTestExample
{
    /**
     * Logger of the class
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TranslatorGeneratorTestExampleExampleBase.class);
     ...
     */
    public TranslatorGeneratorTestExampleExampleBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
    {
    ...
    public void initializeFileDirectories() throws APIRestGeneratorException
    {
        ...
        TranslatorGeneratorTestExampleExampleBase.LOGGER.info("Initializing files and creating directories with base [{}] for translator [{}] for the examples",
