 ...
 * ------------------------------------------------
 */
public class PackageUtilsTestExample extends PackageUtilsClientWeb
{
	/**
	 * Public constructor
	 ...
	 */
	public PackageUtilsTestExample(final String businessUnit, final String projectTitle, final String projectVersion)
	{
