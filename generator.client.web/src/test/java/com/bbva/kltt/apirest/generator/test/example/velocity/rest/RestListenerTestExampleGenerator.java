 ...
 * ------------------------------------------------
 */
public class RestListenerTestExampleGenerator extends GeneratorBaseTestExample
{
    /**
     ...
     */
    public RestListenerTestExampleGenerator(final File baseDestDir,
    ...
    protected VelocityContext createVelocityContext()
    {
        ...
        // Templates
        context.put(ConstantsOutputTestExample.VP_JS_TEMPL_LIST_MET_H,
        			this.getTemplateResourceName(ConstantsCommon.STRING_EMPTY,
                                                 ConstantsOutputTestExample.VP_JS_TEMPL_LIST_MET_H)) ;
