 ...
 * ------------------------------------------------
 */
public class OutputLanguageParametersTestExample extends OutputLanguageParametersClientWeb
{
	 ...
	 */
	public OutputLanguageParametersTestExample(final ParsedInfoHandler parsedInfoHandler)
	{
	...
	public OutputParameter createNewOutputParameter(final Parameter parameter)
	{
		...
		return new OutputParameterTestExample(parameter.getItem(),
