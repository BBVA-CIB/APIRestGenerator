 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorBaseTestExample extends TranslatorGeneratorBaseClientWeb
{
    /**
     * Logger of the class
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TranslatorGeneratorBaseTestExample.class);
     ...
     */
    public TranslatorGeneratorBaseTestExample(final String translatorType,
                                             final GenerationParameters generationParams,
                                             final ParsedInfoHandler parsedInfoHandler)
    {
        super(translatorType, generationParams, parsedInfoHandler, ConstantsOutputTestExample.PACKAGE_VM_RESOURCES);
    }
    ...
    public void initializeFileDirectories() throws APIRestGeneratorException
    {
        ...
        TranslatorGeneratorBaseTestExample.LOGGER.info("Initializing files and creating directories with base [{}] for translator [{}]",
