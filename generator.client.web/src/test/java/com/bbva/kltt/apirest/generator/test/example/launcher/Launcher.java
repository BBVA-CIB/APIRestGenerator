...
package com.bbva.kltt.apirest.generator.test.example.launcher;
...
public class Launcher extends GlobalLauncher
{
    ...
    public static void main(final String[] args) throws APIRestGeneratorException
    {
        ...
        launcher.launch(args, ConstantsOutputTestExample.MODULE_NAME, ConstantsOutputTestExample.GENERATOR_INIT_CLASS);
    }
}
