 ...
 * ------------------------------------------------
 */
public class OutputLanguageConsumesProducesTestExample extends OutputLanguageConsumesProduces
{
	/**
	 * Public constructor
	 * @param parsedInfoHandler with the parsed information handler
	 */
	public OutputLanguageConsumesProducesTestExample(final ParsedInfoHandler parsedInfoHandler)
	{
		super(parsedInfoHandler, new OutputLanguageSeparatorsTestExample()) ;
	}
