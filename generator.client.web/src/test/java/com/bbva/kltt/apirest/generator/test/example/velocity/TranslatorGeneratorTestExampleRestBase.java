 ...
 * ------------------------------------------------
 */
public abstract class TranslatorGeneratorTestExampleRestBase extends TranslatorGeneratorBaseTestExample implements IOperationsRest
{
	/**
	 ...
	 */
	public TranslatorGeneratorTestExampleRestBase(final GenerationParameters generationParams, final ParsedInfoHandler parsedInfoHandler)
	{
