 ...
 * ------------------------------------------------
 */
public class OutputParameterTestExample extends OutputParameterClientWeb
{
	/**
	 * Public constructor
	 ...
	 */
	public OutputParameterTestExample(final Item item, final String description, final String type, final String name, final boolean autoInjected)
	{
